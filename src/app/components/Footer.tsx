    ...
    <footer className="bg-[#121826] text-white py-10">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 pb-8 border-b border-white/10">
          ...
          <div>
            <h4
              className="text-white/80 text-xs uppercase tracking-widest font-semibold mb-4"
            ...
            <div className="flex flex-col gap-2.5">
              ...
              <div className="flex items-center gap-3 mt-2">
                <a
                  ...
                  aria-label="Facebook"
                >
                  <svg viewBox="0 0 24 24" fill="currentColor" width="14" height="14" className="text-white/60">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-8 h-8 rounded-full bg-white/10 hover:bg-green-600 transition-colors flex items-center justify-center"
                  aria-label="WhatsApp"
                >
                  <svg viewBox="0 0 24 24" fill="currentColor" width="14" height="14" className="text-white/60">
